        ...
        <Container className="spacing-lg">
          ...
          <Flex>
              ...
              <ul>
                ...
                <li>
                  <FlexContact>
                    ...
                    <a href="mailto: rob@3drtinc.com">{Info.mail1}</a>
                  </FlexContact>
                </li>
                <li>
                  <FlexContact>
            ...
            <FlexItem className="spacing">
              ...
              <p>
                ...
                ,{" "}
                <ButtonInline to="/services/3d-fusion">3D Fusion</ButtonInline>,
                production consulting, and technology sales. We recognize that
                the Third Industrial Revolution, which began with the digital
                age, is accelerating and we want to assist others in their
                efforts to engage and embrace the technologies currently
          ...
          <Copyright>
            <ul>
              ...
              <li>
                <a target="_popup" href="https://www.3drtinc.com/terms-of-use">
                  Terms of use
                </a>
              </li>
              <li>
                <a
                  target="_popup"
                  href="https://www.3drtinc.com/privacy-policy"
                >
                  Privacy Policy
                </a>
              </li>
