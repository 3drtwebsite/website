...
export default function TermsOfUse() {
  return (
    <>
      <SEO
        title="Terms of Use"
        description="3'D Revolution Technologies Terms of Use."
      />
      <HeaderBasic />
      <Section>
        <Container>
                  ...
                  >
                    ...
                    >
                      ...
                      <bdt
                        ...
                        data-type="question"
                      >
                        3'D Revolution Technologies Inc.
                      </bdt>
                      ...
                      >
                        <a
                          href="http://www.3drtinc.com"
                          target="_blank"
                          data-custom-class="link"
                        >
                          http://www.3drtinc.com
                        </a>
                      </bdt>{" "}
                            ...
                            >
                              ...
                              >
                                <span data-custom-class="body_text">
                                  ...
                                  infringe the proprietary rights, including but
                                  not limited to the copyright, patent,
                                  ...
                                  authorize us, the Site, and other users of the
                                  ...
                                  letters, spam, mass mailings, or other forms
                                  of solicitation.
                                  <br />
                                  ...
                                  any offensive comments that are connected to
                    ...
                    <bdt data-type="body">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <a
                              href="http://www.3drtinc.com/privacy-policy"
                              target="_blank"
                              data-custom-class="link"
                            >
                              http://www.3drtinc.com/privacy-policy
                            </a>
                          </bdt>
                        </b>
                        <span
                        ...
                        >
                          ...
                          of Use. Please be advised the Site is hosted in{" "}
                          <span
                            style={{
                              fontSize: "11pt",
                              lineHeight: "16.8667px",
              ...
              <div align="center" style={{ textAlign: "left" }}>
                ...
                >
                  ...
                  >
                    <bdt
                      ...
                      data-type="question"
                    >
                      <strong>3'D Revolution Technologies Inc.</strong>
                    </bdt>
                  </span>
                ...
                >
                  <span style={{ color: "rgb(89, 89, 89)" }}>
                    <strong>
                      <span style={{ fontSize: "15px" }}>
                        <bdt className="question">19 Wilshire Pl SW</bdt>
                        <bdt className="statement-end-if-in-editor" />
                        <bdt className="block-component" />
                      </span>
                    </strong>
                ...
                >
                  <span style={{ color: "rgb(89, 89, 89)" }}>
                    <strong>
                      <span style={{ fontSize: "15px" }}>
                        <bdt className="question">Calgary</bdt>
                        <bdt className="block-component" />,{" "}
                        <bdt className="question">Alberta</bdt>
                        <bdt className="block-component" />
                      </span>
                    </strong>
                    <strong>
                  ...
                  <span style={{ color: "rgb(89, 89, 89)" }}>
                    <strong>
                      <span style={{ fontSize: "15px" }}>
                        <bdt className="question">T3C 3M7</bdt>
                        <bdt className="statement-end-if-in-editor" />{" "}
                        <bdt className="block-component" />
                        <bdt className="block-component" />
                      </span>
                ...
                >
                  ...
                  >
                    <bdt
                      ...
                      data-type="question"
                    >
                      <strong>info@3drtinc.com</strong>
                    </bdt>
                  </span>
                </div>
                <br />
